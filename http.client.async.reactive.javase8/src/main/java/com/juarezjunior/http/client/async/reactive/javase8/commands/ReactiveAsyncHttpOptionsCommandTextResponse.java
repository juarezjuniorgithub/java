...
public class ReactiveAsyncHttpOptionsCommandTextResponse<T> extends HystrixCommand<CompletionStage<String>> {
	...
	public ReactiveAsyncHttpOptionsCommandTextResponse(final String targetUrl, final int timeout,
			Object... additionalProperties) {

		super(Setter
				.withGroupKey(HystrixCommandGroupKey.Factory
						.asKey(ReactiveAsyncCommandsEnum.OPTIONS_COMMAND_TEXT_GROUP.value()))
	...
	public ReactiveAsyncHttpOptionsCommandTextResponse(final Link link, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandTextResponse(final URI uri, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandTextResponse(final UriBuilder uriBuilder, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandTextResponse(final RxWebTarget<RxCompletionStageInvoker> target,
	...
	protected CompletionStage<String> run() throws Exception {
		...
		case STRING_URL:
			...
			response = callbackDispatcher.optionsRequestForTextResponse(stringTarget, informedAdditionalProperties);
			break;

		case LINK:
			ReactiveAsyncHelper.checkLink(linkTarget);
			response = callbackDispatcher.optionsRequestForTextResponse(linkTarget, informedAdditionalProperties);
			break;

		case URI:
			ReactiveAsyncHelper.checkUri(uriTarget);
			response = callbackDispatcher.optionsRequestForTextResponse(uriTarget, informedAdditionalProperties);
			break;

		case URIBUILDER:
			ReactiveAsyncHelper.checkUriBuilder(uriBuilderTarget);
			response = callbackDispatcher.optionsRequestForTextResponse(uriBuilderTarget, informedAdditionalProperties);
			break;

		case WEBTARGET:
			ReactiveAsyncHelper.checkWebTarget(webTarget);
			response = callbackDispatcher.optionsRequestForTextResponse(webTarget, informedAdditionalProperties);
			break;
