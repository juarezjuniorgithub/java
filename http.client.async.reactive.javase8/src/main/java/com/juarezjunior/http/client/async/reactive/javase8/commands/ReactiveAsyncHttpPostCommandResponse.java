...
public class ReactiveAsyncHttpPostCommandResponse<T> extends HystrixCommand<CompletionStage<Response>> {
	...
	public ReactiveAsyncHttpPostCommandResponse(final String targetUrl, final Entity<?> entity, final int timeout,
			Object... additionalProperties) {

		super(Setter
				.withGroupKey(
						HystrixCommandGroupKey.Factory.asKey(ReactiveAsyncCommandsEnum.POST_COMMAND_RESP_GROUP.value()))
	...
	public ReactiveAsyncHttpPostCommandResponse(final Link link, final Entity<?> entity, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpPostCommandResponse(final URI uri, final Entity<?> entity, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpPostCommandResponse(final UriBuilder uriBuilder, final Entity<?> entity, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpPostCommandResponse(final RxWebTarget<RxCompletionStageInvoker> target,
	...
	protected CompletionStage<Response> run() throws Exception {
		...
		case STRING_URL:
			...
			response = callbackDispatcher.postRequestForResponse(stringTarget, entity, informedAdditionalProperties);
			break;

		case LINK:
			ReactiveAsyncHelper.validateUrlTypeLink(linkTarget, entity);
			response = callbackDispatcher.postRequestForResponse(linkTarget, entity, informedAdditionalProperties);
			break;

		case URI:
			ReactiveAsyncHelper.validateUrlTypeUri(uriTarget, entity);
			response = callbackDispatcher.postRequestForResponse(uriTarget, entity, informedAdditionalProperties);
			break;

		case URIBUILDER:
			ReactiveAsyncHelper.validateUrlTypeBuilder(uriBuilderTarget, entity);
			response = callbackDispatcher.postRequestForResponse(uriBuilderTarget, entity,
					informedAdditionalProperties);
			break;

		case WEBTARGET:
			ReactiveAsyncHelper.validateUrlTypeWebTarget(webTarget, entity);
			response = callbackDispatcher.postRequestForResponse(webTarget, entity, informedAdditionalProperties);
			break;
