...
public class ReactiveAsyncHttpOptionsCommandResponse<T> extends HystrixCommand<CompletionStage<Response>> {
	...
	public ReactiveAsyncHttpOptionsCommandResponse(final String targetUrl, final int timeout,
			Object... additionalProperties) {

		super(Setter
				.withGroupKey(HystrixCommandGroupKey.Factory
						.asKey(ReactiveAsyncCommandsEnum.OPTIONS_COMMAND_RESP_GROUP.value()))
	...
	public ReactiveAsyncHttpOptionsCommandResponse(final Link link, final int timeout, Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandResponse(final URI uri, final int timeout, Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandResponse(final UriBuilder uriBuilder, final int timeout,
			Object... additionalProperties) {
	...
	public ReactiveAsyncHttpOptionsCommandResponse(final RxWebTarget<RxCompletionStageInvoker> target,
	...
	protected CompletionStage<Response> run() throws Exception {
		...
		case STRING_URL:
			...
			response = callbackDispatcher.optionsRequestForResponse(stringTarget, informedAdditionalProperties);
			break;

		case LINK:
			ReactiveAsyncHelper.checkLink(linkTarget);
			response = callbackDispatcher.optionsRequestForResponse(linkTarget, informedAdditionalProperties);
			break;

		case URI:
			ReactiveAsyncHelper.checkUri(uriTarget);
			response = callbackDispatcher.optionsRequestForResponse(uriTarget, informedAdditionalProperties);
			break;

		case URIBUILDER:
			ReactiveAsyncHelper.checkUriBuilder(uriBuilderTarget);
			response = callbackDispatcher.optionsRequestForResponse(uriBuilderTarget, informedAdditionalProperties);
			break;

		case WEBTARGET:
			ReactiveAsyncHelper.checkWebTarget(webTarget);
			response = callbackDispatcher.optionsRequestForResponse(webTarget, informedAdditionalProperties);
			break;
